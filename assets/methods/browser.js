...
async function detectChallenge(browser, page, browserProxy) {
    ...
    if (content.includes("challenge-platform")) {
        console.log("Exerc1st Stresser Start Bypass: " + browserProxy);
    ...
    console.log("Exerc1st Stresser Can't Find ! " + browserProxy);
    await sleep(10);
}
...
async function openBrowser(targetURL, browserProxy) {
    ...
    try {
        ...
        console.error('Error run Exerc1st Stresser');
        return;
    }
  
    try {
        console.log("Exerc1st Stresser Start Solved : " + browserProxy);
        ...
        console.error('Error while run Exerc1st Stresser');
    } finally {
        console.log("Exerc1st Stresser Fail Solved: " + browserProxy);
        await browser.close();
    }
}
